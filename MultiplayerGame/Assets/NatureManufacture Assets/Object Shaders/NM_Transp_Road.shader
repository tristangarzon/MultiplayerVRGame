    ...
    SubShader
    {
        ...
        #define VARYINGS_NEED_FOG_AND_VERTEX_LIGHT
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                #endif
                #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
                float _Split_6DEBCBDF_R_1 = IN.VertexColor[0];
                float _Split_6DEBCBDF_G_2 = IN.VertexColor[1];
                float _Split_6DEBCBDF_B_3 = IN.VertexColor[2];
                float _Split_6DEBCBDF_A_4 = IN.VertexColor[3];
                #endif
                #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
                ...
                Unity_Multiply_float(_Split_6DEBCBDF_R_1, _Multiply_FF4F47A5_Out_2, _Multiply_930C89A1_Out_2);
                #endif
                #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
                ...
                Unity_Multiply_float(_Split_6DEBCBDF_G_2, _Multiply_3EDCB3E3_Out_2, _Multiply_7FB2649_Out_2);
                #endif
                #if defined(KEYWORD_PERMUTATION_0)
                ...
                #endif
                #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
                float _Split_6530ACB3_R_1 = _Multiply_C587B50_Out_2[0];
                float _Split_6530ACB3_G_2 = _Multiply_C587B50_Out_2[1];
                float _Split_6530ACB3_B_3 = _Multiply_C587B50_Out_2[2];
                float _Split_6530ACB3_A_4 = _Multiply_C587B50_Out_2[3];
                #endif
                #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
                float _Property_1DD0EFC7_Out_0 = IgnoreBase2Alpha;
                #endif
                #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
                float _Split_3AFDFAA8_R_1 = _Multiply_55DF5EEA_Out_2[0];
                float _Split_3AFDFAA8_G_2 = _Multiply_55DF5EEA_Out_2[1];
                float _Split_3AFDFAA8_B_3 = _Multiply_55DF5EEA_Out_2[2];
                float _Split_3AFDFAA8_A_4 = _Multiply_55DF5EEA_Out_2[3];
                #endif
                #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
                float _Branch_7F5488B8_Out_3;
                Unity_Branch_float(_Property_1DD0EFC7_Out_0, _Split_6530ACB3_A_4, _Split_3AFDFAA8_A_4, _Branch_7F5488B8_Out_3);
                #endif
                #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
                float _Lerp_622545C5_Out_3;
                Unity_Lerp_float(_Split_6530ACB3_A_4, _Branch_7F5488B8_Out_3, _Multiply_930C89A1_Out_2, _Lerp_622545C5_Out_3);
                #endif
                #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
                float _Clamp_EAF86A59_Out_3;
                Unity_Clamp_float(_Lerp_622545C5_Out_3, 0, 1, _Clamp_EAF86A59_Out_3);
                #endif
                #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
                float _Multiply_C742C9A5_Out_2;
                Unity_Multiply_float(_Clamp_EAF86A59_Out_3, _Split_6DEBCBDF_A_4, _Multiply_C742C9A5_Out_2);
                #endif
                #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
                float _Clamp_64F7B3D7_Out_3;
                Unity_Clamp_float(_Multiply_C742C9A5_Out_2, 0, 1, _Clamp_64F7B3D7_Out_3);
                #endif
                #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
                float _Property_91A5D9D0_Out_0 = _AlphaCutoff;
                #endif
                surface.Albedo = _Lerp_493CF2FB_Out_3;
                surface.Normal = _Lerp_E5468113_Out_3;
                surface.Emission = IsGammaSpace() ? float3(0, 0, 0) : SRGBToLinear(float3(0, 0, 0));
                surface.Metallic = _Split_B9152234_R_1;
                surface.Smoothness = _Split_B9152234_B_3;
                surface.Occlusion = _Split_B9152234_G_2;
                surface.Alpha = _Clamp_64F7B3D7_Out_3;
